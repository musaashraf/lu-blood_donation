...
import com.example.musa_ashraf.blood_donation.Admin.AdminDonorControl;
...
public class MyAdapter  extends RecyclerView.Adapter<MyAdapter.MyAdapterViewHolder> {
    private Context c;
   private ArrayList<VDAdapter> arrayList;

    public MyAdapter(Context c, ArrayList<VDAdapter> arrayList) {
        this.c = c;
    ...
    public MyAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v  = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.add_donor_sample,viewGroup,false);
